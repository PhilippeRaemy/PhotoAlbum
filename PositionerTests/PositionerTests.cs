...
namespace PositionerTests
{
    ...
    public class PositionerTests
    {
        ...
        static readonly Positioner HFlatLeftPosPad = new Positioner { Cols = 4, Rows = 1, HShape = HShape.Left, VShape = VShape.Flat, Margin = 0, Padding = 0.1f };
        ...
        static readonly Positioner VFlatLeftPosPad = new Positioner { Cols = 1, Rows = 4, HShape = HShape.Left, VShape = VShape.Flat, Margin = 0, Padding = 0.1f };
